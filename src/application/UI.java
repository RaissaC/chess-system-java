...
public class UI {
    ...
    private static void printCapturedPieces(List<ChessPiece> captured) {
        List<ChessPiece> white = captured.stream().filter(color -> color.getColor() == Color.WHITE).toList();
        List<ChessPiece> black = captured.stream().filter(color -> color.getColor() == Color.BLACK).toList();
